...
CREATE LOGIN AI_AGENT_RO WITH PASSWORD = 'Agent@1234#';
CREATE USER AI_AGENT_RO FOR LOGIN AI_AGENT_RO;
GO

-- 4. Grant access ONLY to the semantic view, explicitly denying everything else
GRANT SELECT ON FDE_VIEWS.VW_ACTIVE_FLEET TO AI_AGENT_RO;
DENY SELECT ON dbo.TBL_SC_FLEET_HIST_RAW TO AI_AGENT_RO;
DENY INSERT, UPDATE, DELETE, ALTER ON SCHEMA::dbo TO AI_AGENT_RO;
GO
